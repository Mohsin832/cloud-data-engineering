...
WHERE city = 'CA' AND phone IS NOT NULL
...
-- Part b:
SELECT TOP 5 PERCENT * FROM production.products ORDER BY list_price ASC
...
-- Part b:
SELECT DISTINCT state, city FROM sales.customers ORDER BY state ASC, city ASC
